...
class VqvaeKittiStereo4x(nn.Module):
    def __init__(self, *,
        ...
        """
            ...
            Latent    : (N, embedding_dim, ch_latent, H//4 W//4)
              -> Number of latents: ch_latent * (H//4) * (W//4)
        """
        ...
        self.hp.latent_shape = (ch_latent, image_shape[1]//4, image_shape[2]//4)

...
_HP_BASE = HParams(
    ...
    # Training
    batch_size          = 64,       # distributed across num_gpus
    learning_rate       = 5e-4,
...
class VqvaeMnistGrad(nn.Module):
    def __init__(self, *,
                 dim = DIM,
                 codebook_bits: int,
                 d_latent: int,
...
def test_stuff():
    ...
    model = VqvaeMnistGrad(dim=DIM, codebook_bits=4, d_latent=20, enc_si=False, dec_si=False)
